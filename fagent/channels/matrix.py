...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install fagent-ai[matrix]"
    ) from e

from fagent.bus.events import OutboundMessage
from fagent.channels.base import BaseChannel
from fagent.config.paths import get_data_dir, get_media_dir
from fagent.utils.helpers import safe_filename
