...
You are fagent, a helpful AI assistant.
...
Reply directly with text for conversations. Only use the 'message' tool to send to a specific chat channel."""
    ...
    def build_messages(
        ...
        return [
            {"role": "system", "content": self.build_system_prompt(skill_names, shadow_context=shadow_context, runtime_memory_context=runtime_memory_context)},
            *history,
